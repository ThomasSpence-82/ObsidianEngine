...
{
    // Enable debug layer in debug builds (helps catch GPU errors early)
#if defined(_DEBUG)
    {
...
//    (Skip software adapters; prefer discrete GPUs)
// ------------------------------------------------------------------------
for (UINT adapterIndex = 0;
    m_factory->EnumAdapters1(adapterIndex, &m_adapter) != DXGI_ERROR_NOT_FOUND;
    ++adapterIndex)
{
    ...
    break; // Found a hardware adapter
}
...
// Cache descriptor size for later use
